...
function spacingHeight(textarea) {
  return parseInt(textarea.css('paddingBottom')) + parseInt(textarea.css('paddingTop')) + parseInt(textarea.css('borderBottomWidth')) + parseInt(textarea.css('borderTopWidth'));
}
...
describe("TextArea", function () {
  ...
  beforeEach(function () {
    textarea = $("#js-single-line-textarea").val('').css('maxHeight', '').textareaAutoSize();
  });
